package com.nodoor.module.billing;
...
import com.nodoor.module.funtion.BillingListener;
import com.nodoor.module.funtion.PurchaseListener;
import com.nodoor.module.funtion.UpdatePurchaseListener;
...
public class AppPurchase {
    ...
    private void handlePurchase(Purchase purchase) {
        ...
        GamLogEventManager.onTrackRevenuePurchase((float) price, currency, idPurchaseCurrent, typeIap);

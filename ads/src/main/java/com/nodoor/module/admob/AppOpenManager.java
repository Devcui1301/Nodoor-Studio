package com.nodoor.module.admob;
...
import com.nodoor.module.dialog.ResumeLoadingDialog;
import com.nodoor.module.event.GamLogEventManager;
import com.nodoor.module.funtion.AdCallback;
import com.nodoor.module.funtion.AdType;
                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                GamLogEventManager.logPaidAdImpression(myApplication.getApplicationContext(),
                                        adValue,
                                        ad.getAdUnitId(),
                                        ad.getResponseInfo()
                    ...
                    splashAd.setFullScreenContentCallback(
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    super.onAdClicked();
                                    if (currentActivity != null) {
                                        GamLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            GamLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
                ...
                new AppOpenAd.AppOpenAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull AppOpenAd appOpenAd) {
                        ...
                        appOpenAd.setOnPaidEventListener(adValue -> {
                            ...
                            GamLogEventManager.logPaidAdjustWithToken(adValue, appOpenAd.getAdUnitId(), GamAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            GamLogEventManager.logPaidAdImpression(activity,
                                    adValue,
                                    interstitialAd.getAdUnitId(),
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            GamLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), GamAdConfig.ADJUST_TOKEN_TIKTOK);
                        });
        ...
        new Handler().postDelayed(() -> {
            splashAd.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            GamLogEventManager.logClickAdsEvent(context, splashAdId);

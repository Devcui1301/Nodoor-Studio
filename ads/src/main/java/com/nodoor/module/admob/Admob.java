...
import com.nodoor.module.funtion.AdmobHelper;
    ...
    public void onShowSplash(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterstitialSplash.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdShowedFullScreenContent() {
                com.nodoor.module.admob.AppOpenManager.getInstance().setInterstitialShowing(true);
                isShowLoadingSplash = false;
            }

            @Override
            public void onAdDismissedFullScreenContent() {
                com.nodoor.module.admob.AppOpenManager.getInstance().setInterstitialShowing(false);
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    com.nodoor.module.admob.AppOpenManager.getInstance().disableAdResumeByClickAction();
